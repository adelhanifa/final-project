        ...
        <div className="container register">
          <div className="row">
            ...
            <div className="col-md-9 register-right">
              <div>
                <div>
                  <h3 className="register-heading mt-2">
                    Choose any category of goals or <br />
                    <b className="text-danger"> Create your own target </b>
                  </h3>
                  <form
                    onSubmit={this.onSubmitFormUser}
                    className="row register-form form-check"
                  >
                      ...
                      <section className="border p-3">
                        {this.state.displayGoals.map((item, index) => {
                          if (index < 7) {
                            ...
                            let classes =
                              "btn btn-outline-secondary btn-rounded form-check-label d-flex align-items-center mt-2 px-1 px-sm-4";
                            return (
                              <div
